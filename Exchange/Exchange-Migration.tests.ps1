...
# describes the function Install-Prerequisite
Describe 'Install-Prerequisite' {
  ...
  Context 'Running without arguments'   {
    ...
    It 'runs without errors' {
      ...
      # scriptblock (braces):
      { Install-Prerequisite } | Should Not Throw
    }
    It 'does something' {
      # call function Install-Prerequisite and pipe the result to an assertion
      # Example:
      # Install-Prerequisite | Should Be 'Expected Output'
      # Hint: 
    ...
    It 'does not return anything'     {
      Install-Prerequisite | Should BeNullOrEmpty 
    }
  }
}
