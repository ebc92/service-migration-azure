...
Function New-AzureStackVnet{
    ...
    Try {
        ...
        if(!$nic){   
            ...
            $nic = New-AzureRmNetworkInterface -ResourceGroupName $res -Location $Location -Name $VMNicName -NetworkSecurityGroup $nsg -IpConfigurationName $VMNicName -ErrorAction Stop
