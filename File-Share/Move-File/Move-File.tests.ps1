...
# describes the function Deploy-FileShare
Describe 'Deploy-FileShare' {
  ...
  Context 'Running without arguments'   {
    ...
    It 'runs without errors' {
      ...
      # scriptblock (braces):
      { Deploy-FileShare } | Should Not Throw
    }
    It 'does something' {
      # call function Deploy-FileShare and pipe the result to an assertion
      # Example:
      # Deploy-FileShare | Should Be 'Expected Output'
      # Hint: 
    ...
    It 'does not return anything'     {
      Deploy-FileShare | Should BeNullOrEmpty 
    }
  }
}
